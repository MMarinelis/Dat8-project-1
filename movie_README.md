...
Microsoft, a prominent player in the technology industry, is preparing to enter the domain of original video contentand launching a new film studio. As Microsoft currently lacks experience in this space, this endeavor will work to close the knowledge gap by analysing data which demonstrates some key traits as to how and why movies have reached box office success and popularity.
